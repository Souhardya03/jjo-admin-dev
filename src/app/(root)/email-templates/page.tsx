...
const EmailTemplatesPage = () => {
	...
	const [addTemplate, { isLoading: addTemplateIsLoading }] =
		useAddTemplatesMutation();
	const {
		data: templatesData,
	...
	const [editTemplate, { isLoading: editTemplateIsLoading }] =
		useEditTemplatesMutation();
	...
	const handleDelete = async (id: string) => {
		const deleteTemp = deleteTemplate({ id }).unwrap();
		toast.promise(deleteTemp, {
			loading: "Deleting email template...",
			success: `Email template has been  deleted successfully.`,
									...
									<TableRow
										...
										<TableCell className="text-right">
											<DropdownMenu>
												...
												<DropdownMenuContent
													align="end"
													className="w-40 rounded-xl border-gray-100 shadow-lg">
													<DropdownMenuItem
														onClick={(e) => {
				...
				<DialogContent className="max-w-3xl rounded-2xl max-h-[85vh] flex flex-col">
						...
						<div className="flex items-start justify-between">
							<div>
								...
								<DialogDescription>
									Last updated:{" "}
									{viewTemplate &&
										format(new Date(viewTemplate.updatedAt), "PPP p")}
								</DialogDescription>
							</div>
						</div>
					</DialogHeader>
					...
					<div className="flex-1 overflow-y-auto py-6 space-y-6">
						<div className="space-y-2">
							<Label className="text-gray-500 uppercase text-xs tracking-wider font-semibold">
								Subject Line
							</Label>
